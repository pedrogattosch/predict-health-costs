...
Execute o notebook `fcc_predict_health_costs_with_regression.ipynb` no [Google Colab](https://colab.research.google.com/) para utilizar as bibliotecas necessárias sem instalação manual.
...
Run the `fcc_predict_health_costs_with_regression.ipynb` notebook on [Google Colab](https://colab.research.google.com/) to use all required libraries without manual setup.
